...
const response = await fetch(`${API_BASE_URL}/cart`, {
  ...
  const handleCODOrder = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      let url = `${API_BASE_URL}/orders/cod`;
      if (buyNowProduct) url = `${API_BASE_URL}/orders/cod/buy-now?productId=${buyNowProduct.productId}&quantity=${buyNowQuantity}`;
  ...
  const handleRazorpayOrder = async () => {
    ...
    try {
      ...
      let createOrderUrl = `${API_BASE_URL}/payment/create-order`;
      if (buyNowProduct) createOrderUrl = `${API_BASE_URL}/payment/create-order/buy-now?productId=${buyNowProduct.productId}&quantity=${buyNowQuantity}`;
