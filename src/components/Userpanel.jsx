...
import {
  ...
  AlertCircle, Clock, ChevronRight, Truck, Award,
  ArrowRight, Shield, RefreshCw, ChevronLeft, Quote,
} from "lucide-react";
...
const OFFER_CAROUSEL_IMAGES = [
  { src: 'https://i.ibb.co/3YmpD1mm/1772243720426.png', alt: 'Slide 1' },
  { src: 'https://i.ibb.co/RGX307Fr/IMG-20260228-WA0001.jpg', alt: 'Slide 2' },
  { src: 'https://i.ibb.co/XxD9H8N7/1772245166688.png', alt: 'Slide 3' },
  { src: 'https://i.ibb.co/ZR27GpQx/1772245852373.png', alt: 'Slide 4' },
];
...
const UserPanel = () => {
  ...
  const fetchFavouritedIds = async () => {
    try {
      const token = localStorage.getItem("token");
      if (!token) return;
      const res = await fetch(`${API_BASE_URL}/favourites/ids`, {
  ...
  const handleToggleFavourite = async (e, product) => {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/favourites/toggle/${product.productId}`, {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/products/all`, { method: "GET", headers });
            ...
            <div className="profile-section" ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div className="profile-dropdown">
                  ...
                  <button className="dropdown-item" onClick={() => { navigate("/favourites"); setDropdownOpen(false); }}>
      ...
      <main className="panel-content">
        ...
        <div className="hero-banner">
          <div className="hero-banner-content">
            <div className="hero-badge">
              <span className="badge-icon">🥖</span>Artisan Bakery Since 1985
            </div>
            ...
            <p className="hero-subtitle">
              Discover our collection of handcrafted breads, pastries, and cakes made daily with
            ...
            <div className="hero-actions">
              ...
              <button
                ...
                onClick={() => document.querySelector(".featured-offers-section")?.scrollIntoView({ behavior: "smooth" })}
              >
                View Offers
              </button>
            </div>
          ...
          <div className="hero-visual">
            <div className="hero-image-grid">
              <div className="grid-item item-1">
                <img src="https://images.unsplash.com/photo-1509440159596-0249088772ff?w=500&auto=format&fit=crop" alt="Fresh bread" />
              </div>
              ...
              <div className="grid-item item-4">
                <img src="https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=500&auto=format&fit=crop" alt="Cookies" />
              </div>
            </div>
            ...
            <div className="experience-badge">
              <div className="years">35+</div>
              <div className="years-text">Years of<br />Tradition</div>
            </div>
          </div>
        </div>
        ...
        <div className="hero-offer-banner">
          <div className="hero-banner-content">
            ...
            <p className="hero-description">
              Get <span className="highlight">20% off</span> on all pastries when you order before 10 AM. Start your day with the
              perfect breakfast!
            </p>
            <div className="hero-countdown">
              <div className="countdown-item">
                <div className="countdown-value">{countdown.h}</div>
                <div className="countdown-label">Hours</div>
              </div>
              <div className="countdown-item">
                <div className="countdown-value">{countdown.m}</div>
        ...
        <div className="products-section">
          ...
          {loading ? (
            <div className="loading-state">
              ...
              {apiStatus && (
                <p style={{ fontSize: "0.9rem", color: "#888", marginTop: "0.5rem" }}>{apiStatus}</p>
              )}
            </div>
          ) : error ? (
                ...
                {displayedProducts.map((product) => (
                  ...
                  >
                    <div className="product-image-container">
                      ...
                      >
                        <Heart
                          size={20}
                          style={{
                            fill: favouritedIds.has(product.productId) ? "#ef4444" : "none",
                            color: favouritedIds.has(product.productId) ? "#ef4444" : "currentColor",
                            transition: "all 0.2s",
                          }}
                        />
                      </button>
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-footer">
                        ...
                        >
                          {addingToCart[product.productId]
                            ? <><span className="spinner-small" /><span>Adding…</span></>
                            : product.isAvailable
                      ...
                      {viewMode === "list" && product.allergens && (
        ...
        <div className="why-us-section">
          <div className="why-us-inner">
            ...
            <p>
              Every loaf, every pastry, every cake — made from scratch each morning using
              time-honoured techniques and the finest ingredients.
            </p>
        ...
        <div className="featured-offers-section">
          ...
          <div className="offers-grid">
            {[
              {
                badge: "-20%", emoji: "🥐", title: "Morning Bliss", sub: "Breakfast Special",
                desc: "Fresh croissants, danishes, and morning pastries. Perfect with your morning coffee!",
                time: <><Clock size={16} /><span>Until 10 AM</span></>,
                orig: "₹1,999", price: "₹1,599", btn: "Order Breakfast",
              },
              {
                badge: "BESTSELLER", emoji: "🍞", title: "Family Feast", sub: "Assorted Bread Box",
                desc: "6 assorted artisan breads, 2 pastries, and our signature house spreads.",
                time: <><Tag size={16} /><span>Save ₹1,200</span></>,
                orig: "₹3,999", price: "₹2,799", btn: "Get Family Pack",
              },
              {
                badge: "NEW", emoji: "🎂", title: "Sweet Indulgence", sub: "Premium Cakes & Desserts",
                desc: "Try our new cheesecake collection — available in 6 extraordinary flavors.",
                time: <><Award size={16} /><span>Limited Edition</span></>,
                orig: "₹3,299", price: "₹2,499", btn: "Explore Desserts",
              },
            ].map((o, i) => (
              <div className="offer-card" key={i}>
                <span className="offer-badge">{o.badge}</span>
                <div className="offer-image">
                  <div className="offer-image-placeholder">{o.emoji}</div>
                </div>
                <div className="offer-content">
                  ...
                  <div className="offer-meta">
                    ...
                    <div className="offer-price">
                      <span className="original-price">{o.orig}</span>{o.price}
                    </div>
                  </div>
                  <button
                    className="offer-btn"
        ...
        <div className="testimonials-section">
          ...
          <div className="testimonial-slider">
            <button
              className="tslide-btn tslide-prev"
            ...
            <div className="testimonial-card">
              ...
              <div className="t-author">
                ...
                <div>
                  <strong>{currentT.name}</strong>
                  <span>{currentT.loc}</span>
                </div>
              </div>
            </div>
            <button
              className="tslide-btn tslide-next"
